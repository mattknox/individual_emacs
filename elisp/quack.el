...
(defconst quack-pltish-paren-face 'quack-pltish-paren-face)
(defface  quack-pltish-paren-face
  '((((class color) (background light)) (:foreground "gray2"))
    (((class color) (background dark))  (:foreground "gray3"))
    (((class grayscale))                (:foreground "gray"))
    (t                                  ()))
  "Face used for parentheses when `quack-fontify-style' is `plt'."
  :group 'quack)
...
(defface  quack-pltish-defn-face
  '((((class color) (background light)) (:bold t :foreground "yellow3"))
    (((class color) (background dark))  (:bold t :foreground "yellow1"))
