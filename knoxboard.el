...
;;
;; Defines a colour scheme resembling that of the original TextMate Knoxboard colour theme.
;; To use add the following to your .emacs file (requires the color-theme package):
;;
;; (require 'color-theme)
;; (color-theme-initialize)
;; (load-file "~/.emacs.d/themes/color-theme-knoxboard.el")
;;
;; And then (color-theme-knoxboard) to activate it.
;;
;; MIT License Copyright (c) 2008 JD Huntington <jdhuntington at gmail dot com>
;; Credits due to the excellent TextMate Knoxboard theme
;;
;; All patches welcome
...
(defun color-theme-knoxboard ()
  "Color theme by JD Huntington, based off the TextMate Knoxboard theme, created 2008-11-27"
  (interactive)
  (color-theme-install
